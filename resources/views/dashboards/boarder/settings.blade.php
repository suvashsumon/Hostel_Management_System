@extends('dashboards.boarder.layouts.boarder_layout') @section('title',
'Settings') @section('settings', 'active') @section('extra_css')
<style>
    .user-pic {
        border-radius: 50%;
        width: 100px;
...
<div class="row">
    <div class="col-md-6 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                <form
                    action="{{ route('boarder.change_personal_information') }}"
                    method="post"
                >
                    @csrf
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form
                    action="{{ route('boarder.change_password') }}"
                    method="post"
                >
                    @csrf
                    <div class="input-group mb-2 mr-sm-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    action="{{ route('boarder.change_profile_pic') }}"
                >
                    @csrf
